...
contract LayerC {
   ...
   string[] private Relayers; // Array of RelayerIds
    ...
    mapping(string => RelayerC) public RelayersC;  // Maps relayerId to Relayer structure
    ...
    function placeBid(
        ...
        require(
            RelayersC[RelayerAdToId[relayer]].relayer == msg.sender,
        ...
        RelayersC[RelayerAdToId[relayer]].assignedBidId = bidIdStr;
